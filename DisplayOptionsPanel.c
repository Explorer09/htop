...
DisplayOptionsPanel* DisplayOptionsPanel_new(Settings* settings, ScreenManager* scr) {
   ...
   Panel_add(super, (Object*) ListItem_new("Global", 0));
   Panel_add(super, (Object*) CheckItem_newByRef(xStrdup("Count CPUs from 0 instead of 1"), &(settings->countCPUsFromZero)));
   Panel_add(super, (Object*) ListItem_new("Meters", 1));
   Panel_add(super, (Object*) CheckItem_newByRef(xStrdup("Display a margin around header field"), &(settings->headerMargin)));
